...
app.intent('Default Welcome Intent', conv => 
{
    ...
    else
    {
        ...
        conv.ask(new SimpleResponse({
            speech: 'Hi, I am Cinde. I can help you with your incidents and service requests: For example, you can ask me things like:',
            text:'Hi, I am Cinde. I can help you with your incidents and service requests: For example, you can ask me things like:',        
    ...
    return new Promise(function(resolve,reject)
    {
        GetIncidentDetails(userID,noOfTickets,function(IncidentDetailsArr)
        {
            ...
            {            
                ...
                textToSpeech = 'There are '+slicedIncidentDetailsArr.length+ ' New incidents. Below are the details. Select the incident if you wish to carry out any specific actions. If the desired incident is not listed below, request you to provide specific details so that I can help you with the right details';
        ...
        GetSRDetails(userID,noOfTickets,function(SRDetailsArr)
        {
            ...
            {            
                ...
                for (var i = 0; i < slicedSRDetailsArr.length; i++)
                {
                    ...
                    Items[slicedSRDetailsArr[i].Ticket_No].description = 'Status: '+slicedSRDetailsArr[0].Status+','+' Logged Time: '+ slicedSRDetailsArr[0].Reg_Time+','+' Symptom: '+slicedSRDetailsArr[0].Description; 
                }

                textToSpeech = 'There are '+slicedSRDetailsArr.length+ ' New SRs. Below are the details. Select the SR if you wish to carry out any specific actions. If the desired SR is not listed below, request you to provide specific details so that I can help you with the right details';
